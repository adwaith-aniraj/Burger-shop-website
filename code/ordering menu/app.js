                              ...
                              const products = [
                                        ...
                                        { name: "Double Cheese Explosion", price: 279 },
                                        { name: "Veg Supreme XL", price: 239 },
                                        { name: "Spicy Crunch Burger", price: 219 }
                              ];
                              ...
                              products.forEach(item => {
                                        ...
                                        card.innerHTML = `
        <img src="https://source.unsplash.com/300x300/?burger,food" alt="burger">
        <h3>${item.name}</h3>
